...
export default function Home() {
  ...
  return (
    <div className="flex flex-col md:px-12 px-0 bg-background font-raleway items-center min-h-screen">
      <h1 className="text-6xl font-bold text-active mt-20">Greenhouse Gas Footprint Compute</h1>
      <h1 className="text-6xl font-bold text-active mt-8">From Car Travel</h1>
      <h2 className="text-primary text-2xl font-light mt-10">
        Compute Greenhouse Gas Footprint from Car Travel.
      </h2>
      <form
        className="sm:mx-auto mt-10 md:max-w-3xl justify-center flex flex-col w-full sm:flex"
        onSubmit={(e) => {
          calculateFootprint();
          e.preventDefault();
          e.stopPropagation();
      ...
      {response && (
        <div className="mt-10">
          <span className="text-2xl text-primary">
            The Greenhouse Gas Footprint is{" "}
